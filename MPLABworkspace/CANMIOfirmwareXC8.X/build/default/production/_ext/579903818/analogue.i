...
# 1 "../../github/CANMIOfirmware/analogue.c"
...
# 44 "../../github/CANMIOfirmware/analogue.c"
static unsigned char portInProgress;
AnalogueStates analogueState[16U];

unsigned char setupIo;
unsigned char setupState;
static unsigned char haveRequestedAdc;
...
analogueState[io].eventState = 0U;
analogueState[io].portState = 0U;
}
...
if ((NV->io[portInProgress].type == 5U) || (NV->io[portInProgress].type == 6U)) {
...
# 97
if ((setupState == 0U) || (portInProgress != setupIo)) {
if (NV->io[portInProgress].type == 6U) {
...
if ((analogueState[portInProgress].eventState != 2U) && ((short)adc >= hthreshold)) {

if (analogueState[portInProgress].portState == 1U) {
sendProducedEvent(((8U + 4U*(portInProgress))+1U), (BOOL)(!(NV->io[portInProgress].flags & 0x40U)));
}
analogueState[portInProgress].eventState = 2U;
} else if ((analogueState[portInProgress].eventState == 2U) && ((short)adc <= hhysteresis)) {

if (analogueState[portInProgress].portState == 1U) {
if (!(NV->io[portInProgress].flags & 0x08U)) {
sendProducedEvent(((8U + 4U*(portInProgress))+1U), NV->io[portInProgress].flags & 0x40U);
}
}
analogueState[portInProgress].eventState = 0U;
}
} else {
...
if ((analogueState[portInProgress].eventState != 1U) && ((short)adc <= lthreshold)) {

if (analogueState[portInProgress].portState == 1U) {
sendProducedEvent(((8U + 4U*(portInProgress))+0U), (unsigned char)(!(NV->io[portInProgress].flags & 0x40U)));
}
analogueState[portInProgress].eventState = 1U;
} else if ((analogueState[portInProgress].eventState == 1U) && ((short)adc >= lhysteresis)) {

if (analogueState[portInProgress].portState == 1U) {
if (!(NV->io[portInProgress].flags & 0x08U)) {
sendProducedEvent(((8U + 4U*(portInProgress))+0U), NV->io[portInProgress].flags & 0x40U);
}
}
analogueState[portInProgress].eventState = 0U;
}
...
cbusMsg[d6] = adc >> 8U;
cbusSendOpcNN(0xFF, 0xFD, -1U, cbusMsg);
if (setupState == 2U) {

writeFlashByte((BYTE*) (0xFF80U + (16U + 7U*(portInProgress) + 5U)), cbusMsg[d6]);
writeFlashByte((BYTE*) (0xFF80U + (16U + 7U*(portInProgress) + 6U)), cbusMsg[d7]);
}
setupState = 0U;
}
analogueState[portInProgress].portState = 1U;
}
}

portInProgress++;
if (portInProgress >= 16U) {
portInProgress = 0U;
}
