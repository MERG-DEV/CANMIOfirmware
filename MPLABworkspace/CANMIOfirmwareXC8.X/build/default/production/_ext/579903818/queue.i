...
# 1 "../../github/CANMIOfirmware/queue.c"
...
# 46 "../../github/CANMIOfirmware/queue.c"
BOOL push(Queue * q, unsigned char a) {
if (((q->writeIdx+1)&((q->size)-1)) == q->readIdx) return 0;
...
# 74
unsigned char peek(Queue * q, unsigned char index) {
if (q->readIdx == q->writeIdx) return 0;
index += q->readIdx;

if (index >= q->size) {
index -= q->size;
}
if (index == q->writeIdx) return 0;
