...
# 1 "../../github/CANMIOfirmware/digitalOut.c"
...
# 66 "../../github/CANMIOfirmware/digitalOut.c"
unsigned char pulseDelays[16U];
signed char flashDelays[16U];
...
ee_write(((WORD)(((BYTE*)(0x3FF-40)))-17)+io, state);
sendInvertedProducedEvent(((8U + 4U*(io))+0U), 1,
NV->io[io].flags & 0x40U, 1, 1);
return;
}
flashDelays[io] = 0;

actionState = (unsigned char)(state == 1U);
...
ee_write(((WORD)(((BYTE*)(0x3FF-40)))-17)+io, 2U);
} else {
ee_write(((WORD)(((BYTE*)(0x3FF-40)))-17)+io, actionState?1U:2U);
}

pinState = actionState;
if (NV->io[io].flags & 0x20U) {
...
if (NV->io[io].flags & 0x08U) {
if (actionState) {


sendInvertedProducedEvent(((8U + 4U*(io))+0U), actionState,
NV->io[io].flags & 0x40U, 1, 1);
}
} else {
...
sendProducedEvent(((8U + 4U*(io))+0U), (BOOL)(!(NV->io[io].flags & 0x40U)));
}
doneAction();
}
if (pulseDelays[io] != 0) {
