...
# 1 "../../github/CANMIOfirmware/main.c"
...
# 6 "C:\Program Files\Microchip\xc8\v2.36\pic\include\c90\stddef.h"
...
# 51 "../../github/CANMIOfirmware/mioFLiM.h"
...
# 84 "../../github/CANMIOfirmware\hwsettings.h"
extern BYTE clkMHz;

# 104
void setclkMHz( void );

# 60 "../../github/CBUSlib\StatusLeds.h"
enum FlashStates
{
flNone=0,
flFLiMSlow,
...
# 46 "../../github/CANMIOfirmware/inputs.h"
...
# 15 "../../github/CANMIOfirmware/analogue.h"
...
extern AnalogueStates analogueState[16U];

# 16 "../../github/CANMIOfirmware/digitalOut.h"
...
# 53 "../../github/CBUSlib\timedResponse.h"
...
# 18 "../../github/CANMIOfirmware/nvCache.h"
extern ModuleNvDefs * loadNvCache(void);

# 166 "../../github/CANMIOfirmware/main.c"
const  Config configs[16U] = {
...
eventTable = (const EventTable *)0xEF80U;
...
if (!started && (unsigned char)((tickGet() - startTime.Val) > (unsigned long)((NV->sendSodDelay * (62500/10)) + (62500*2)))) {
started = 1;

sendProducedEvent(1U, 1);
...
if ((tickGet() - lastServoStartTime.Val) > 5*(62500/2000)) {
startServos();
lastServoStartTime.Val = tickGet();
}

if (started) {
if ((tickGet() - lastInputScanTime.Val) > 5*(62500/1000)) {
inputScan();
...
if ((tickGet() - lastTimedResponseTime.Val) > (unsigned long)((NV->responseDelay) * (62500/1000))) {
doTimedResponse();
...
if (ee_read((WORD)((BYTE*)(0x3FF-5))) != 0x01) {
...
ee_write((WORD)((BYTE*)(0x3FF-5)), 0x01);
writeFlashByte((BYTE*)(0xFF80U + 0U), (BYTE)0x02U);

loadNvCache();

}

if (NV->nv_version != 0x02U) {
...
for (evIndex=1; evIndex<20U; evIndex++) {
int ev = getEv(i, evIndex);
if (ev > 0) {
if (((unsigned char)ev & 0x7FU) >= 8U) {
unsigned char action;
unsigned char simultaneous = (unsigned char)ev & 0x80U;
ev &= 0x7FU;
io = ((((unsigned char)ev)-8U)/4U);
action = ((((unsigned char)ev)-8U)%4U);
ev = simultaneous | ((8U + 5U*(io)) + action);
writeEv(i, evIndex, (unsigned char)ev);
}
}
if (ev == -5) {
break;
...
addEvent(nodeID, en, 0, paction, 1);
}
break;
...
paction = ((8U + 4U*(io))+0U);
if ( ! getProducedEvent(paction)) {
addEvent(nodeID, 100+en, 0, paction, 1);
}
paction = ((8U + 4U*(io))+1U);
if ( ! getProducedEvent(paction)) {
addEvent(nodeID, 300+en, 0, paction, 1);
}
paction = ((8U + 4U*(io))+2U);
if ( ! getProducedEvent(paction)) {
addEvent(nodeID, 200+en, 0, paction, 1);
}
break;
...
# 548
void factoryResetEE(void) {
ee_write((WORD)((BYTE*)(0x3FF)), 0);
ee_write((WORD)((BYTE*)(0x3FF-1)), 0x01);
ee_write_short((WORD)((WORD*)(0x3FF-3)), 0x00);
ee_write((WORD)((BYTE*)(0x3FF-4)), fsSLiM);
}
...
{
cbusMsg[d3] = 2;
cbusSendOpcMyNN( 0, 0x6F, cbusMsg);
}
return 1;
case 0x5E:
...
switch (NV->io[i].type) {
case 1U:
if (NV->io[i].flags & 0x04U) {
setDigitalOutput(i, ee_read((WORD)((WORD)(((BYTE*)(0x3FF-40)))-17)+i));
} else {
action = (NV->io[i].flags & 0x20U) ? 1U : 2U;
setDigitalOutput(i, action);

ee_write(((WORD)(((BYTE*)(0x3FF-40)))-17)+i, action);
}
break;
...
setDigitalOutput(i, NV->io[i].flags & 0x10U);
...
if ((NV->io[i].type == 0U) || (NV->io[i].type == 5U) || (NV->io[i].type == 6U)) {
TRISA |= (1U << configs[i].no);
} else {
TRISA &= ~(1U << configs[i].no);
}
break;
...
if ((NV->io[i].type == 5U) || (NV->io[i].type == 6U)) {
