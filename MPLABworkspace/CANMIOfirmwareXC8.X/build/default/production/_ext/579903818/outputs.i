...
# 1 "../../github/CANMIOfirmware/outputs.c"
...
# 57 "../../github/CANMIOfirmware/outputs.c"
extern void setOuputPin(unsigned char io, BOOL state);

extern unsigned char pulseDelays[16U];

# 69
void startOutput(unsigned char io, unsigned char action, unsigned char type) {
switch(type) {
case 0U:
...
# 102
void setOutputState(unsigned char io, unsigned char action, unsigned char type) {
switch(type) {
case 0U:
case 5U:
case 6U:
...
setOutputPin(io, (NV->io[io].flags & 0x20U));
return;
...
return (BOOL)(servoState[io] != MOVING);
...
return (BOOL)((targetPos[io] == currentPos[io]) && ((servoState[io] == STOPPED) || (servoState[io] == OFF)));
