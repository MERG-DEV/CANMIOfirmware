...
# 1 "../../github/CANMIOfirmware/mioFLiM.c"
...
# 53 "../../github/CANMIOfirmware/mioFLiM.c"
extern void mioNvInit();

# 83
const  ParamVals FLiMparams @0x820 = {
165,
'c',
32,
255U,
20U,
(sizeof(ModuleNvDefs)-1),
3U,
(3U+8U+16U),
15,
1,
...
const  FCUParams FCUparams @0x838 = {
sizeof(ParamVals),
(DWORD)module_type,
(WORD)165+'c'+32+255U+20U+(sizeof(ModuleNvDefs)-1)+3U+(3U+8U+16U)+15+1 +(0x0800U>>8)+(0x0800U&0xFF)+1+1U+sizeof(ParamVals)+((0x0800U + 0x20U + sizeof(ParamBlock))>>8)+((0x0800U + 0x20U + sizeof(ParamBlock))&0xFF)
};

const  SpareParams spareparams;
const  char module_type[] = "MIO    ";
