...
# 1 "../../github/CANMIOfirmware/inputs.c"
...
# 54 "../../github/CANMIOfirmware/inputs.c"
static BYTE inputState[16U];

# 58
BYTE outputState[16U];

# 62
static BYTE delayCount[16U];
...
if (NV->io[io].flags & 0x10U) {
outputState[io] = ee_read(((WORD)(((BYTE*)(0x3FF-40)))-17)+io);
}
delayCount[io] = 0;
}
}
...
ee_write(((WORD)(((BYTE*)(0x3FF-40)))-17)+io, outputState[io]);
} else {
outputState[io] = input;
}
...
if (NV->io[io].flags & 0x40U) {
sendProducedEvent(((8U + 4U*(io))+0U), 0);
} else {
sendProducedEvent(((8U + 4U*(io))+0U), 1);
}
} else {
if (NV->io[io].flags & 0x40U) {
sendProducedEvent(((8U + 4U*(io))+1U), 0);
} else {
sendProducedEvent(((8U + 4U*(io))+1U), 1);
}
}
} else {

if (NV->io[io].flags & 0x40U) {
sendProducedEvent(((8U + 4U*(io))+0U), (BOOL)(!outputState[io]));
} else {
sendProducedEvent(((8U + 4U*(io))+0U), outputState[io]);
}
}
} else {
delayCount[io]++;
