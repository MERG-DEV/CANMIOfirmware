...
# 62 "../../github/CBUSlib/cbus.c"
WORD nodeID;
BYTE cbusMsg[sizeof(CanPacket)];

# 74
void cbusInit( WORD initNodeID )
{

nodeID = ee_read_short( (WORD)((WORD*)(0x3FF-3)) );
...
if (datalen > 0)
msg[d0] |= (unsigned char)(datalen << 5U);
...
if ((cbusNum == 0) || (cbusNum == 0xFF) )
canQueueRx( (CanPacket*)msg );
...
if ((cbusNum == 0) || (cbusNum == 0xFF) )
return canSend( msg, (unsigned char)((unsigned char)(msg[d0] >> 5U)+1U));
