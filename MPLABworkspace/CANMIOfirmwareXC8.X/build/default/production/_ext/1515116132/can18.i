...
# 70 "../../github/CBUSlib/can18.c"
CanPacket canTxFifo[16U];
CanPacket canRxFifo[16U];
...
BYTE enumerationResults[(0x7F/8)+1];
...
if (initCanID == 0)
{
canID = ee_read( (WORD)((BYTE*)(0x3FF-1)) );
...
{
canID = initCanID;
ee_write((WORD)((BYTE*)(0x3FF-1)), canID);
}
...
TXB0DLC = 0;
TXB0SIDH = 0b10110000 | ((canID & 0x78U) >>3U);
TXB0SIDL = (canID & 0x07U) << 5U;
...
TXB1DLC = 0x40;
TXB1SIDH = 0b10110000 | ((canID & 0x78U) >>3U);
TXB1SIDL = TXB0SIDL;
...
TXB2DLC = 0;
TXB2SIDH = 0b10110000 | ((canID & 0x78U) >>3U);
TXB2SIDL = TXB0SIDL;
...
canID = newCanId;
TXB0SIDH &= 0b11110000;
TXB0SIDH |= ((newCanId & 0x78U) >>3U);
TXB0SIDL = ( newCanId & 0x07U) << 5U;

TXB1SIDH &= 0b11110000;
TXB1SIDH |= ((newCanId & 0x78U) >>3U);
TXB1SIDL = TXB0SIDL;

TXB2SIDH &= 0b11110000;
TXB2SIDH |= ((newCanId & 0x78U) >>3U);
TXB2SIDL = TXB0SIDL;

ee_write((WORD)((BYTE*)(0x3FF-1)), newCanId );
return 1;
} else {
return 0;
}
...
if (((txIndexNextUsed == txIndexNextFree) || canTransmitFailed) && (!TXB0CONbits.TXREQ))
{
ptr = (BYTE*) & TXB0CON;
...
if (++txIndexNextFree == 16U )
txIndexNextFree = 0U;

if (txIndexNextUsed == txIndexNextFree)
txIndexNextFree = 0xFFU;
}
else
txOflowCount++;
...
txFifoUsage++;
hiIndex = ( txIndexNextFree < txIndexNextUsed ? txIndexNextFree + 16U : txIndexNextFree);
...
txIndexNextFree = txIndexNextUsed;

if (++txIndexNextUsed == 16U )
txIndexNextUsed = 0;
...
if ((tickGet() - canTransmitTimeout.Val) > 62500)
{
canTransmitFailed = 1;
txTimeoutCount++;
TXB0CONbits.TXREQ = 0;
...
memcpy(msg->buffer, (void*) ptr, ptr->buffer[dlc] + 6U);
...
hiIndex = ( rxIndexNextFree < rxIndexNextUsed ? rxIndexNextFree + 16U : rxIndexNextFree);
...
else if (enumerationInProgress && ((tickGet() - enumerationStartTime.Val) > (62500/10) ))
{
