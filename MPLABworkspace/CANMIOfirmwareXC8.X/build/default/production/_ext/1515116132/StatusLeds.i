...
# 54 "../../github/CBUSlib/StatusLeds.c"
TickValue flashTime;
...
void doFLiMFlash(void)
{
LATBbits.LATB6 = (BOOL)(! LATBbits.LATB6);
...
case flFLiMFast:
if ((tickGet() - flashTime.Val) > (62500/2)/3)
doFLiMFlash();
break;
}
switch(flickerState) {
...
# 169
void shortFlicker() {
if (flickerTime.Val < tickGet() + (62500/10)) {
flickerTime.Val = tickGet() + (62500/10);
...
# 179
void longFlicker() {
flickerTime.Val = tickGet() + (62500/2);
flickerState = flickWaitingOn;
}
