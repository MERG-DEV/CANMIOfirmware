...
# 1 "../../github/CANMIOfirmware/servo.c"

# 18 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC18F-K_DFP/1.5.114/xc8\pic\include\xc.h"
...
# 7 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC18F-K_DFP/1.5.114/xc8\pic\include\builtins.h"
...
# 53 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC18F-K_DFP/1.5.114/xc8\pic\include\proc\pic18f26k80.h"
...
# 19 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC18F-K_DFP/1.5.114/xc8\pic\include\pic18.h"
...
# 23 "../../github/CBUSlib\GenericTypeDefs.h"
typedef unsigned char BYTE;
typedef unsigned int WORD;
typedef unsigned char BOOL;
typedef unsigned long DWORD;

# 178 "../../github/CANMIOfirmware/mioNv.h"
typedef struct {
unsigned char type;
unsigned char flags;
union {
...
# 180 "../../github/CANMIOfirmware/mioEvents.h"
...
# 209 "../../github/CANMIOfirmware/mioEvents.h"
extern BOOL sendInvertedProducedEvent(unsigned char action, BOOL state, BOOL invert,
BOOL can_send_on, BOOL can_send_off);

# 137 "../../github/CANMIOfirmware/module.h"
extern unsigned char APP_addEvent(WORD nodeNumber, WORD eventNumber, BYTE evNum, BYTE evVal, BOOL forceOwnNN);

# 47 "../../github/CANMIOfirmware/config.h"
typedef struct {
unsigned char pin;
char port;
unsigned char no;
...
extern const  Config configs[16U];

# 175 "../../github/CBUSlib\TickTime.h"
...
# 40 "../../github/CANMIOfirmware/actionQueue.h"
extern void actionQueueInit(void);
extern BOOL pushAction(unsigned char a);
extern unsigned char getAction(void);
extern void doneAction(void);
extern unsigned char pullAction(void);
extern unsigned char peekActionQueue(unsigned char index);
extern void deleteActionQueue(unsigned char index);
extern void setExpeditedActions(void);
extern void setNormalActions(void);

# 41 "../../github/CANMIOfirmware/servo.h"
typedef enum {
OFF,
STOPPED,
MOVING,
...
extern ServoState servoState[16U];
extern unsigned char currentPos[16U];
extern unsigned char targetPos[16U];
extern unsigned char stepsPerPollSpeed[16U];
extern int speed[16U];
...
extern void setServoState(unsigned char io, unsigned char action);
extern void setBounceState(unsigned char io, unsigned char action);
extern void setMultiState(unsigned char io, unsigned char action);

extern void setServoPosition(unsigned char io, unsigned char pos);

extern void startServoOutput(unsigned char io, unsigned char action);
extern void startBounceOutput(unsigned char io, unsigned char action);
extern void startMultiOutput(unsigned char io, unsigned char action);

extern unsigned char isNoServoPulses(void);

# 15 "../../github/CANMIOfirmware/bounce.h"
extern void initBounce(unsigned char io);
extern BOOL bounceDown(unsigned char io);
extern BOOL bounceUp(unsigned char io);

# 42 "../../github/CANMIOfirmware/outputs.h"
void setOutputPosition(unsigned char i, unsigned char state, unsigned char type);

# 45 "../../github/CBUSlib\happeningsActions.h"
extern void deleteActionRange(unsigned char action, unsigned char number);
extern void deleteHappeningRange(unsigned char action, unsigned char number);
extern BOOL getProducedEvent(unsigned char action);
extern BOOL getDefaultProducedEvent(unsigned char paction);
extern BOOL sendProducedEvent(unsigned char paction, BOOL on);
...
extern BYTE happening2Event[(8U + 16U * 4U)];

# 84 "../../github/CANMIOfirmware/servo.c"
...
ServoState servoState[16U];
unsigned char currentPos[16U];
unsigned char targetPos[16U];
unsigned char stepsPerPollSpeed[16U];
unsigned char pollsPerStepSpeed[16U];
unsigned char pollCount[16U];
int speed[16U];
unsigned char loopCount[16U];

# 112
TickValue ticksWhenStopped[16U];
...
if ((NV->io[io].type == 2U) || (NV->io[io].type == 3U) || (NV->io[io].type == 4U)) {
if (NV->io[io].flags & 0x04U) {
setOutputPosition(io, ee_read(((WORD)(((BYTE*)(0x3FF-40)))-17)+io), NV->io[io].type);
} else {
setOutputPosition(io, NV->io[io].nv_io.nv_servo.servo_start_pos, NV->io[io].type);
}
}
...
type = NV->io[servoInBlock+8U].type;
if ((type == 2U) || (type == 3U) || (type == 4U)) {
if (servoState[servoInBlock+8U] != OFF) setupTimer3(servoInBlock+8U);
}
}
...
TMR1 = -(3600U + (WORD)19U * currentPos[io]);

# 193
setOutputPin(io, (unsigned char)( ! (NV->io[io].flags & 0x20U)));
T1CONbits.TMR1ON = 1;
}
void setupTimer3(unsigned char io) {


TMR3 = -(3600U + (WORD)19U * currentPos[io]);
...
T1CONbits.TMR1ON = 0;
setOutputPin(servoInBlock, NV->io[servoInBlock].flags & 0x20U);
}

void timer3DoneInterruptHandler(void) {
T3CONbits.TMR3ON = 0;
setOutputPin(servoInBlock+8U, NV->io[servoInBlock+8U].flags & 0x20U);
}
...
case 2U:
midway = (unsigned char)(NV->io[io].nv_io.nv_servo.servo_end_pos)/2U +
(NV->io[io].nv_io.nv_servo.servo_start_pos)/2U;
beforeMidway=0;
switch (servoState[io]) {
case STARTING:
if (currentPos[io]==NV->io[io].nv_io.nv_servo.servo_start_pos) {
sendProducedEvent(((8U + 4U*(io))+0U), NV->io[io].flags & 0x40U);
} else {
sendProducedEvent(((8U + 4U*(io))+2U), NV->io[io].flags & 0x40U);
}
...
sendProducedEvent(((8U + 4U*(io))+1U), (unsigned char)( ! (NV->io[io].flags & 0x40U)));
}
...
sendProducedEvent(((8U + 4U*(io))+1U), NV->io[io].flags & 0x40U);
}
}
if (targetPos[io] == currentPos[io]) {
servoState[io] = STOPPED;
...
if (currentPos[io] == NV->io[io].nv_io.nv_servo.servo_start_pos) {
sendProducedEvent(((8U + 4U*(io))+0U), (unsigned char)( ! (NV->io[io].flags & 0x40U)));
} else {
sendProducedEvent(((8U + 4U*(io))+2U), (unsigned char)( ! (NV->io[io].flags & 0x40U)));
}
ee_write(((WORD)(((BYTE*)(0x3FF-40)))-17)+io, currentPos[io]);
}
break;
}
break;
...
sendProducedEvent(((8U + 4U*(io))+3U), NV->io[io].flags & 0x40U);
}
servoState[io] = MOVING;
...
if (currentPos[io] == NV->io[io].nv_io.nv_multi.multi_pos4) {
sendProducedEvent(((8U + 4U*(io))+3U), (unsigned char)( !(NV->io[io].flags & 0x40U)));
}
ee_write(((WORD)(((BYTE*)(0x3FF-40)))-17)+io, currentPos[io]);
}
break;
...
# 479
void startServoOutput(unsigned char io, unsigned char action) {
switch (action) {
case 2U:
...
if (stepsPerPollSpeed[io] > 234U) {
stepsPerPollSpeed[io] -= 234U;
pollsPerStepSpeed[io] = 0U;
} else {
pollsPerStepSpeed[io] = 234U - stepsPerPollSpeed[io] +1U;
pollCount[io] = 1;
stepsPerPollSpeed[io] = 0U;
}
servoState[io] = STARTING;
}

# 507
void startBounceOutput(unsigned char io, unsigned char action) {
switch (action) {
case 2U:
speed[io] = 0;
break;
...
# 525
void startMultiOutput(unsigned char io, unsigned char action) {
...
pollsPerStepSpeed[io] = 234U - stepsPerPollSpeed[io] +1;
pollCount[io] = 1;
stepsPerPollSpeed[io] = 0;
}
servoState[io] = STARTING;
...
# 547
void setServoState(unsigned char io, unsigned char action) {
switch (action) {
case 2U:
if (NV->io[io].flags & 0x01U) {
...
# 574
void setBounceState(unsigned char io, unsigned char action) {
switch (action) {
case 2U:
if (NV->io[io].flags & 0x01U) {
...
# 598
void setMultiState(unsigned char io, unsigned char action) {
switch (action) {
case 0U:
...
if (T1CONbits.TMR1ON) return 0;
if (T3CONbits.TMR3ON) return 0;
return 1;
}
