...
# 1 "../../github/CANMIOfirmware/actionQueue.c"
...
# 47 "../../github/CANMIOfirmware/queue.h"
...
extern BOOL push(Queue * q, unsigned char a);
extern unsigned char pop(Queue * q);
extern unsigned char peek(Queue * q, unsigned char index);
extern unsigned char quantity(Queue * q);
extern void delete(Queue * q, unsigned char index);

# 43 "../../github/CANMIOfirmware/actionQueue.c"
BYTE normalReadIdx;
BYTE normalWriteIdx;
unsigned char normalQueueBuf[64];
Queue normalQueue;

BYTE expeditedReadIdx;
BYTE expeditedWriteIdx;
unsigned char expeditedQueueBuf[8];
...
# 77
BOOL pushAction(unsigned char a) {
if (expedited) {
...
# 123
unsigned char peekActionQueue(unsigned char index) {
