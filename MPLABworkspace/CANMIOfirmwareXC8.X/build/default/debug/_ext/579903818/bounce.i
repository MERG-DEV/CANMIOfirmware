...
# 1 "../../github/CANMIOfirmware/bounce.c"
...
# 61 "../../github/CANMIOfirmware/bounce.c"
extern ServoState servoState[16U];
extern unsigned char currentPos[16U];
extern unsigned char targetPos[16U];
extern int speed[16U];
...
if (currentPos[io] < (NV->io[io].nv_io.nv_bounce.bounce_lower_pos + speed[io]/30)) {
...
speed[io] += 3U;
currentPos[io] -= (unsigned char)((speed[io]/30)+1);
}
} else {
