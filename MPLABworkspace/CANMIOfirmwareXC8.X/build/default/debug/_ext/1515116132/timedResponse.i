...
# 1 "../../github/CBUSlib/timedResponse.c"
...
# 66 "../../github/CBUSlib/timedResponse.c"
unsigned char timedResponse;
unsigned char timedResponseStep;

extern BOOL sendProducedEvent(unsigned char happening, BOOL on);
...
if (!cbusSendOpcMyNN( 0, 0xF2, cbusMsg )) {
