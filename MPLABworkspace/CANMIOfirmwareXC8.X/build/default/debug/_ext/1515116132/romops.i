...
if ((flashAddr < (0xEF80U&0xFFC0)) || (flashAddr > 0xFFFF)) {
...
if (((WORD)addr < (0xEF80U&0xFFC0)) || ((WORD)addr > 0xFFFF)) {
...
{
writeFlashImage( flashAddr, flashData );
flushFlashImage();
}
...
{
writeFlashImage( (BYTE*)flashAddr, (BYTE)(flashData & 0x00FF) );
writeFlashImage( ((BYTE*)flashAddr)+1, (BYTE)(flashData >> 8) );
}
...
interruptEnabled = INTCONbits.GIE;
do {
EEADRH = addr >> 8;
EEADR = addr & 0xFF;
EEDATA = data;
