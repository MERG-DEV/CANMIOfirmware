...
# 1 "../../github/CBUSlib/happeningsActions.c"
...
# 77 "../../github/CBUSlib/happeningsActions.c"
Event producedEvent;
BOOL getProducedEvent(unsigned char happening) {

# 82
if ((happening < 1U) || (happening >= 1U + (8U + 16U * 4U))) return 0;

if (happening2Event[happening-1U] == 0xff) return 0;
producedEvent.NN = getNN(happening2Event[happening-1U]);
producedEvent.EN = getEN(happening2Event[happening-1U]);
return 1;
...
# 109
BOOL sendProducedEvent(unsigned char happening, BOOL on) {

unsigned char thisBit = (unsigned char)(happening & 0x7);
unsigned char thisByte = (unsigned char)(happening >> 3);
unsigned char status = ee_read((WORD)(((BYTE*)(0x3FF-39))+thisByte));
if (on) {
status |= (unsigned char)(1U<<thisBit);
} else {
status &= (unsigned char)(~(1U<<thisBit));
}
ee_write((WORD)(((BYTE*)(0x3FF-39))+thisByte), status);
...
# 152
void deleteHappeningRange(unsigned char action, unsigned char number) {
unsigned char tableIndex;
for (tableIndex=0; tableIndex < 255U; tableIndex++) {
...
if ((happening >= 1U) && (happening-1U< (8U + 16U * 4U))) {
unsigned char thisBit = (unsigned char)(happening & 0x7);
unsigned char thisByte = (unsigned char)(happening >> 3);
BOOL status = (unsigned char)(ee_read((WORD)(((BYTE*)(0x3FF-39))+thisByte)) & (unsigned char)(1U<<thisBit));
if (nodeNumber == 0) {
cbusMsg[d1] = nodeID >> 8;
...
if (status) {
cbusMsg[d0] = (unsigned char)(nodeNumber == 0 ? 0x9D : 0x93);
} else {
cbusMsg[d0] = (unsigned char)(nodeNumber == 0 ? 0x9E : 0x94);
}
cbusSendMsg(0xFF, cbusMsg);
}
}

# 226
void deleteActionRange(unsigned char action, unsigned char number) {
unsigned char tableIndex;
for (tableIndex=0; tableIndex < 255U; tableIndex++) {
if (validStart(tableIndex)) {
BOOL updated = 0;
